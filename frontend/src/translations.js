const translations = {
    "en": {
      ...
      "add_user": "Add User",
      "sort_by_date_added": "Sort by addition date",
      "add_new_user": "Add New User",
      "cancel": "Cancel",
      "add": "Add",
      "trainee_trainer": "Trainee-Trainer",
      "confirm_update_user": "Apply Changes",
      "sure": "Sure",
      "confirm_delete_user": "Confirm Deletion",
      "confirm_delete_all_users": "Confirm Deletion For All Users",
      "confirm_update_all_users": "Apply Changes For All Users",
      "yes": "Yes",
      "no": "No",
      ...
      "space": "Space",
      "other": "Other",
      "Password_warning_message": "Password must be at least 8 characters long and include one uppercase letter, one lowercase letter, one number, and one special character (@$!%*?&)",
      ...
      "disable_filter": "Disable Filters",
      "hybrid": "Hybrid",
      "confirm_update_training": "Save changes for training",
      "description": "Description",
      "confirm_delete_training": "Confirm deletion of training",
      "confirm_update_all_trainings": "Save changes for all trainings",
      "confirm_delete_all_trainings": "Confirm deletion for all trainings",
      ...
      "application_form": "Training Application Form",
    ...
    "fr": {
      ...
      "space": "Espace",
      "other": "Autre",
      "Password_warning_message": "Le mot de passe doit comporter au moins 8 caractères et inclure une lettre majuscule, une lettre minuscule, un chiffre, et un caractère spécial (@$!%*?&)",
